  ...
  return (
    ...
    >
      <div className="flex-1 px-4 md:px-12 py-16 md:py-20 flex flex-col lg:flex-row justify-start items-start gap-6 lg:gap-12">
        ...
        >
          <motion.div 
            className="w-full flex flex-col justify-center text-white font-semibold leading-tight md:leading-[44px] font-sans text-4xl tracking-tight"
            variants={fadeInUp}
          >
            Frequently Asked Questions
          </motion.div>
          <motion.div 
            className="w-full text-gray-400 text-base font-normal leading-7 font-sans"
            variants={fadeInUp}
          >
        ...
        <motion.div 
          className="w-full lg:flex-1 flex flex-col justify-center items-center"
          ...
          <div className="w-full flex flex-col">
            {faqData.map((item, index) => {
              ...
              return (
                <motion.div 
                  key={index} 
                  className="w-full border-b border-gray-700 overflow-hidden"
                  variants={fadeInUp}
                ...
                >
                  ...
                  <AnimatePresence>
                    {isOpen && (
                      ...
                      >
                        <motion.div 
                          className="px-5 pb-[18px] text-gray-400 text-sm font-normal leading-6 font-sans"
                          initial={{ y: -10 }}
                          animate={{ y: 0 }}
                          exit={{ y: -10 }}
                          transition={{ duration: 0.2 }}
